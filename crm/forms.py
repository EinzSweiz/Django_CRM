...
class RecordCreateForm(forms.ModelForm):
    ...
    phone = forms.CharField(required=True, max_length=50, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Phone', 'label': ''}))
    ...
    zipcode = forms.CharField(required=True, max_length=50, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Zipcode', 'label': ''}))
    class Meta:
        model = Records
        exclude = ('user', )